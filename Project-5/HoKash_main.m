...
% HO_KASHYAP training part:
[a,b,error_save] = HoKash_training(x_75_by_type_and_classes,eta);

% Test part:
[prediction_overall75,prediction_overall25] = HoKash_test(x_75_by_type_and_classes,x_25_by_type_and_classes,a,b);
