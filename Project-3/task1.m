...
for i=1:c
    ...
    for j = 1:D_c75(i)
        ...
        for k = 1:c
            ...
            pred75(k,j) = decision_function(data75{1,i}(:,j),mean(:,k),sigma_det(1,k),sigma_inv(:,:,k),D_c75(k));
    ...
    for j = 1:D_c25(i)
        ...
        for k = 1:c
            ...
            pred25(k,j) = decision_function(data25{1,i}(:,j),mean(:,k),sigma_det(1,k),sigma_inv(:,:,k),D_c75(k));
